public class MinMaxDivideConquer {
  ...
  static Pair minMaxDivideConquer(int[] arr, int low, int high) {
    ...
    mid = (low + high) / 2;
    left = minMaxDivideConquer(arr, low, mid);
    right = minMaxDivideConquer(arr, mid + 1, high);
  ...
  public static void main(String[] args) {
    ...
    Pair result = minMaxDivideConquer(arr, 0, arr.length - 1);
